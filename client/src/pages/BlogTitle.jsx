...
const BlogTitle = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      // ✅ UPDATED PROMPT FOR NUMBER-WISE TITLES
      const prompt = `Generate some blog title ideas for the keyword "${input}" in the category "${selectedCategory}". Return them as a numbered list like:
